...
function Achievements() {
  ...
  return (
    <section
      id="achievements"
      className="py-28 px-6 bg-[var(--bg-surface)] relative overflow-hidden"
    >
        ...
        <div className="md:col-span-6 space-y-4">
          {milestones.map((item, idx) => (
            ...
            >
              ...
              <div
                className={`w-3 h-3 rounded-full ${activeItem === idx ? "bg-[var(--accent-gold)] animate-ping" : "bg-transparent border border-current"}`}
              ></div>
            </div>
          ))}
        </div>
